export default function Recommandation(){
    return(
        ...
        {/* <!-- Grid --> */}
            ...
            <div className="text-center">
            <img className="rounded-xl w-5/6 h-auto  mx-auto" src="https://m.media-amazon.com/images/I/71m89vLNwiL._AC_SL1500_.jpg" alt="Image Description"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
