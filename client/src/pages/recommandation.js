        ...
        {/* <!-- Grid --> */}
            ...
            <a href="https://www.amazon.fr/Gigabyte-GeForce-Eagle-NVIDIA-GDDR6/dp/B096Y1SRFH/ref=sr_1_11?keywords=Geforce+RTX+3060&amp;qid=1696784445&amp;refinements=p_72%253A437873031&amp;rnid=437872031&amp;sr=8-11&amp;ufe=app_do%253Aamzn1.fos.2a4964d5-da8d-479b-a739-01ef3fadb618&_encoding=UTF8&tag=shiftgaming-21&linkCode=ur2&linkId=0ddb1eab14d763b93809a76836628843&camp=1642&creative=6746">
                <div className="text-center">
                    <img width="100%" height="auto" className="rounded-xl w-full h-auto mx-auto" src="https://m.media-amazon.com/images/I/81ClTABCRoL._AC_SL1500_.jpg" alt="carte-graphique-rtx-nvidia"/>
            ...
            <div className="text-center">
                <img width="100%" height="auto" className="rounded-xl w-full h-auto  mx-auto" src="https://m.media-amazon.com/images/I/71Z89ZNhh1L._AC_SL1500_.jpg" alt="pc-portable-asus-predator"/>
                <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                    <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <a href="https://www.amazon.fr/Vibox-V-45-Gamer-Processeur-Graphique/dp/B09348F8FQ/ref=sr_1_4?__mk_fr_FR=%25C3%2585M%25C3%2585%25C5%25BD%25C3%2595%25C3%2591&amp;crid=UMEUB9VVLRU6&amp;keywords=Pc+gamer+-+AMD+Ryzen+5+4500+-+RTX+3050+8Go..&amp;qid=1696784926&amp;sprefix=pc+gamer+-+amd+ryzen+5+4500+-+rtx+3050+8go..%252Caps%252C77&amp;sr=8-4&amp;ufe=app_do%253Aamzn1.fos.f3853b16-5d43-4401-b4fe-e843a596edae&_encoding=UTF8&tag=shiftgaming-21&linkCode=ur2&linkId=d52533b2cbaee69190b192ee4f26e1b0&camp=1642&creative=6746">
                <div className="text-center">
                <img width="100%" height="auto" className="rounded-xl w-4/6 h-auto  mx-auto" src="https://m.media-amazon.com/images/I/71yH1NcJX-L._AC_SL1500_.jpg" alt="pc-gamer"/>
                <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                    <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <div className="text-center">
            <img width="100%" height="auto" className="rounded-xl w-full h-auto  mx-auto" src="https://m.media-amazon.com/images/I/71h1+fva4pL._AC_SL1500_.jpg" alt="pc + ecran + clavier + souris gamer"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <div className="text-center">
            <img width="100%" height="auto" className="rounded-xl sm:w-full sm:h-auto mx-auto" src="https://m.media-amazon.com/images/I/81cGtM0c+UL._AC_SL1500_.jpg" alt="ram-corsaire-rgb"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <div className="text-center">
            <img width="100%" height="auto" className="rounded-xl w-full h-auto  mx-auto" src="https://m.media-amazon.com/images/I/719mEO3dfzL._AC_SL1500_.jpg" alt="ssd-nvme-samsung-disque-dur"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <div className="text-center">
            <img width="100%" height="auto" className="rounded-xl w-5/6 h-auto  mx-auto" src="https://m.media-amazon.com/images/I/71m89vLNwiL._AC_SL1500_.jpg" alt="Ecran pc incurvé"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <div className="text-center">
            <img width="100%" height="auto" className="rounded-xl w-full h-auto  mx-auto" src="https://m.media-amazon.com/images/I/719Sz2rboqL._AC_SL1500_.jpg" alt="ecran-pc-samsung"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <div className="text-center">
            <img width="100%" height="auto" className="rounded-xl w-2/3 h-auto  mx-auto" src="https://m.media-amazon.com/images/I/51y9o94EWkL._AC_SL1000_.jpg" alt="casque-logitech-gaming-x-pro"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
            ...
            <div className="text-center">
            <img width="100%" height="auto" className="rounded-xl w-3/5 h-auto  mx-auto" src="https://m.media-amazon.com/images/I/51PCx1MUjeL._AC_SL1500_.jpg" alt="ps5-console"/>
            <div className="mt-2 flex flex-col gap-1 sm:mt-4">
                <h3 className="text-sm font-medium text-gray-800 sm:text-base lg:text-lg">
