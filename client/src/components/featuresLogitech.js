...
export default function FeaturesSteelseries(){
    ...
    <nav className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4" aria-label="Tabs" role="tablist">
        ...
        <span className="md:flex">
            ...
            <span className="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Qualité de Fabrication Fiable </span>
            <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200"> Les produits Logitech sont connus pour leur durabilité et leur fiabilité. Ils sont conçus pour résister à une utilisation quotidienne.</span>
            </span>
        </span>
        </button>
        ...
        <span className="md:flex">
            ...
            <span className="md:grow md:ml-5">
            <span className="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Innovation Technologique</span>
        ...
        <span className="md:flex">
            ...
            <span className="md:grow md:ml-5">
            <span className="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Gamme de Produits Polyvalente</span>
            <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">
    ...
    <div className="mt-12 md:mt-16">
        <div id="tabs-with-card-4" role="tabpanel" aria-labelledby="tabs-with-card-item-1">
        {/* <!-- Devices --> */}
        ...
        <div id="tabs-with-card-5" className="hidden" role="tabpanel" aria-labelledby="tabs-with-card-item-2">
        {/* <!-- Devices --> */}
        <div className="max-w-[1140px] lg:pb-32 relative">
            {/* <!-- Mobile Device --> */}
            <figure className="hidden absolute bottom-0 left-0 z-[2] max-w-full w-60 h-auto mb-20 ml-20 lg:block">
            <div className="p-1.5 bg-gray-700 rounded-3xl shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(0_0_0_/_20%),_0_2rem_4rem_-2rem_rgb(0_0_0_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(0_0_0_/_20%)]">
                <img className="max-w-full h-auto rounded-[1.25rem]" src="./setup2.webp" alt="w"/>
            </div>
            </figure>
            {/* <!-- End Mobile Device --> */}
            ...
            <div className="bg-gray-800 rounded-b-lg">
                <img className="max-w-full h-auto rounded-b-lg" src="./setup2.webp" alt="12"/>
            </div>
            </figure>
            {/* <!-- End Browser Device --> */}
        </div>
        ...
        <div id="tabs-with-card-6" className="hidden" role="tabpanel" aria-labelledby="tabs-with-card-item-3">
