      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <img  class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto sm:mx-0 text-gray-500" src={require('../assets/bannier-ig.png')}></img>
          ...
          <a href="https://track.effiliation.com/servlet/effi.click?id_compteur=22918210" target="_blank">
            <img width="14px" height="auto" class="py-3 lg:py-5 w-414 h-auto mx-auto sm:mx-0 text-gray-500" src="https://track.effiliation.com/servlet/effi.show?id_compteur=22918210" alt="pub" border="0"/>
          </a>
