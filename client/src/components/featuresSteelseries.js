...
export default function FeaturesSteelseries(){
    ...
    <nav className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4" aria-label="Tabs" role="tablist">
        ...
        <span className="md:flex">
            ...
            <span className="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Un stuff de qualité exceptionnelle</span>
            <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">Produits sont robustes, durables et conçus pour résister aux rigueurs d'une utilisation intensive par les joueurs.</span>
            </span>
        </span>
        </button>
        ...
        <span className="md:flex">
            ...
            <span className="md:grow md:ml-5">
            <span className="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Performance de Pointe</span>
        ...
        <span className="md:flex">
            ...
            <span className="md:grow md:ml-5">
            <span className="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Innovation et design</span>
            <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">
